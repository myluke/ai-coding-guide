...
[![website](https://img.shields.io/badge/read%20online-coding.stormzhang.ai-a6e3a1)](https://coding.stormzhang.ai)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Articles](https://img.shields.io/badge/articles-92-blue.svg)](#contents)

**📖 Read online (dark terminal theme, best experience) → <https://coding.stormzhang.ai>**

![AI Coding Guide](og.png)
...
🟢 **Stable**: all 92 articles drafted, four rounds of review completed (fact-check / wording / 16-subagent re-review). Ongoing: incremental fixes, plus new dedicated articles when new tools ship.

---

If this guide saves you from pitfalls and detours, ⭐ Star it so more people can find it.
